...
IsotopeDocs["arrange-complete"]=function(t){"use strict";var o=$(t),n=o.find(".grid").isotope({masonry:{columnWidth:50}});n.on("arrangeComplete",function(t,o){ID.notify("Isotope arrange completed on "+o.length+" items")}),o.find(".button-group").on("click","li.button",function(){var t=$(this).attr("data-filter");n.isotope({filter:t})})};
IsotopeDocs["filter-sec"]=function(t){"use strict";function o(t){var o="";for(var i in t)o+=t[i];return o}var i=$(t),r=i.find(".grid").isotope({itemSelector:".grid-item",columnWidth:80,transitionDuration:"0.6s"}),n=i.find(".code-display code"),e={};i.on("click",".button",function(){var t=$(this),i=t.parents(".button-group"),a=i.attr("data-filter-group");e[a]=t.attr("data-filter");var s=o(e);r.isotope({filter:s}),n.displayIsotopeCode("filter",s)})};
...
IsotopeDocs["filtering-demo"]=function(t){"use strict";var n=$(t),e=n.find(".grid").isotope({itemSelector:".element-item",layoutMode:"fitRows",transitionDuration:"0.6s"}),i={numberGreaterThan50:function(){var t=$(this).find(".number").text();return parseInt(t,10)>50},ium:function(){var t=$(this).find(".name").text();return t.match(/ium$/)}},r={numberGreaterThan50:"function() {\n  var number = $(this).find('.number').text();\n  return parseInt( number, 10 ) > 50;\n}",ium:"function() {\n  var name = $(this).find('.name').text();\n  return name.match( /ium$/ );\n}"},o=n.find(".code-display code");n.find(".filter-button-group").on("click","li.button",function(){var t=$(this).attr("data-filter"),n=i[t]||t,a=r[t]||t;e.isotope({filter:n}),o.displayIsotopeCode("filter",a)})};
...
IsotopeDocs["sorting-demo"]=function(t){"use strict";var o=$(t),e=o.find(".sort-by-button-group"),r=o.find(".grid").isotope({itemSelector:".element-item",layoutMode:"fitRows",transitionDuration:"0.6s",getSortData:{name:".name",symbol:".symbol",number:".number parseInt",category:"[data-category]",weight:function(t){var o=$(t).find(".weight").text();return parseFloat(o.replace(/[\(\)]/g,""))}}}),i=o.find(".code-display code");e.on("click","li.button",function(){var t=$(this).attr("data-sort-by");r.isotope({sortBy:t}),i.displayIsotopeCode("sortBy",t)})};
...
IsotopeDocs["vertical-list"]=function(t){"use strict";var o=$(t),e=o.find(".vertical-list").isotope({itemSelector:"li",layoutMode:"vertical",transitionDuration:"0.6s",getSortData:{name:".name",symbol:".symbol",number:".number parseInt",category:".category",weight:function(t){var o=$(t).find(".weight").text();return parseFloat(o.replace(/[\(\)]/g,""))}}});o.find(".button-group").on("click","li.button",function(){var t=$(this).attr("data-sort-by");e.isotope({sortBy:t})})};
...
!function(){"use strict";$("[data-js]").each(function(t,s){var c=s.getAttribute("data-js"),e=IsotopeDocs[c]||FizzyDocs[c];e&&e(s)}),$(".manasory-filter").each(function(t,s){var c=$(s);c.find(":active").parent().addClass("active"),c.on("click","input, li.button",function(){c.find(".active").removeClass("active");var t=$(this),s=t.hasClass("button")?t:t.parents(".button");s.addClass("active")})})}();
